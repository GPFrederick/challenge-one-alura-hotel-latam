...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Frederick © 2023");
    ...
    private void Cerrar() {
    	...
    	int choose = JOptionPane.showOptionDialog(this, "Desea cerrar la aplicacion?", "Login", 0, 0, null, buttons, this);
